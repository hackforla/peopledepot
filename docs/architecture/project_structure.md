...
1. Scripts used in the project. These are run in the commandline to do various project tasks. See [Convenience Scripts](../contributing/tools/scripts/index.md) for details.
