...
1. The docker compose file for testing the AWS/production setup locally. See [Test the AWS setup locally](../contributing/howto/test-aws-setup-locally.md) for details.
...
├── requirements.in # (10)!
├── requirements.txt # (11)!
├── requirements-aws.in # (12)!
├── requirements-aws.txt # (13)!
└── setup.cfg # (14)!
```
