...
from core.api.secured_serializers import SecuredUserSerializer
...
class SecuredCreateUser(GenericAPIView):
    permission_classes = []
...
class SecuredUserViewSet(viewsets.ReadOnlyModelViewSet):
    permission_classes = []
    queryset = User.objects.all()
    serializer_class = SecuredUserSerializer


class SecuredGetUsers(GenericAPIView):
    permission_classes = []
