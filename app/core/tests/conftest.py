...
=======
from ..models import Faq_viewed, Project, RecurringEvent, SponsorPartner
>>>>>>> 21e80f1 (initial test defined)
...
@pytest.fixture
def faq_viewed(project):
    return Faq_viewed.objects.create(project=project)
