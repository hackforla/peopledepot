...
class TestUser:
    ...
    def test_is_update_request_valid(self, user_tests_init):
        ...
        show_test_info("")
        show_test_info(f"global admin will succeed for first name, last name, and gmail")
        PermissionUtil.validate_fields_updateable(Seed.garry.user, Seed.valerie.user, ["first_name", "last_name", "gmail"])
        ...
        show_test_info(f"project admin will succeed for first name, last name, and gmail with a project member")
        PermissionUtil.validate_fields_updateable(Seed.wanda.user, Seed.wally.user, ["first_name", "last_name", "gmail"])
