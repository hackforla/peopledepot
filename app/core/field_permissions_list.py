...
from core.user_field_permissions_constants import profile_field_permissions
...
class FieldPermissionsList:
    ...
    # Args:
    #   http_method_field_permissions (dictionary): dictionary of field permissions
    #   for http_methods.  Key: field name. Value: "CRU" or subset of "CRU".
    ...
    @classmethod
    def _get_fields_with_priv(cls, http_method_field_permissions, cru_permission):
        ret_array = []
        for key, value in http_method_field_permissions.items():
    ...
    def derive_cru_fields(cls):
        ...
        for permission_type in [
            ...
            practice_lead_project,
            admin_global,
            profile,  # "R" and "U" are the only applicable field permission values
            self_register_fields,  # "C" is only applicable field permission value
        ]:
...
FieldPermissionsList.derive_cru_fields()
